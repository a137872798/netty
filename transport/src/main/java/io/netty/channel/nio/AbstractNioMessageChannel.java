...
public abstract class AbstractNioMessageChannel extends AbstractNioChannel {
    ...
    private final class NioMessageUnsafe extends AbstractNioUnsafe {
        ...
        /**
         * 针对ServerSocketChannel 接收到 新的连接
         */
        @Override
        public void read() {
            ...
            try {
                try {
                    do {
                        //将接受到的数据设置到readBuf中  针对ServerSocketChannel 就是获取SocketChannel对象
                ...
                for (int i = 0; i < size; i ++) {
                    readPending = false;
                    //每条数据都触发  这里 又会涉及到 ServerBootstrap添加了 ServerBootstrapAcceptor 针对对象的 channelRead方法
